Development Mod Folder for "Funkin' (feat. Lucy) REDUX".
...
3. Run `git clone https://github.com/MintyMaraOfficial/Funkin-Feat.-Lucy-REDUX.git` to clone the base repository.
4. Run `cd Funkin-Feat.-Lucy-REDUX.git` to enter the cloned repository's directory.
